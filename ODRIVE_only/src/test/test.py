...
odrv1.axis0.controller.config.vel_ramp_rate = 30
...
try:
    while True:
        ...
        if int(elapsed_time*2) % 2 == 0:  # Set velocity for even seconds
                odrv0.axis0.controller.input_vel = 1
                odrv1.axis0.controller.input_vel = -6 #6/1
        else:  # Set velocity for odd seconds    
                odrv0.axis0.controller.input_vel = -1
                odrv1.axis0.controller.input_vel = 6
        # if elapsed_time < 5:  # Set velocity for first 10 seconds
        #     if int(elapsed_time*2) % 2 == 0:  # Set velocity for even seconds
        #         odrv0.axis0.controller.input_vel = 1 
        #         odrv1.axis0.controller.input_vel = -2 #6/1
        #     else:  # Set velocity for odd seconds    
        #         odrv0.axis0.controller.input_vel = -1
        #         odrv1.axis0.controller.input_vel = 2
        # elif 5 <= elapsed_time < 10:  # Set velocity for next 10 seconds
        #     if int(elapsed_time*2) % 2 == 0:  # Set velocity for even seconds
        #         odrv0.axis0.controller.input_vel = 1 
        #         odrv1.axis0.controller.input_vel = -12 #6/1
        #     else:  # Set velocity for odd seconds    
        #         odrv0.axis0.controller.input_vel = -1
        #         odrv1.axis0.controller.input_vel = 12
        # else:
        #     if int(elapsed_time*2) % 2 == 0:  # Set velocity for even seconds
        #         odrv0.axis0.controller.input_vel = 1 
        #         odrv1.axis0.controller.input_vel = -6 #6/1
    ...
    with open('s1/data.csv', 'w', newline='') as f:
        writer = csv.writer(f)
