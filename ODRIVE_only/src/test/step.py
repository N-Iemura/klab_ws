...
odrv0.axis0.controller.config.vel_ramp_rate = 60
...
odrv1.axis0.controller.config.vel_ramp_rate = 80
...
try:
    while True:
        ...
        #     odrv1.axis0.controller.input_vel = 50
            ...
            odrv0.axis0.controller.input_pos = -40+initial_position0
            odrv1.axis0.controller.input_vel = 0


        else:
            odrv0.axis0.controller.input_pos = -1.8 +initial_position0
            odrv1.axis0.controller.input_vel = 0
        ...
        # # elif 1<elapsed_time<2: 
        # #     odrv1.axis0.controller.input_vel = 50
        # elif 1 <= elapsed_time < 1.2: 
        #     odrv0.axis0.controller.input_vel = -50
        #     odrv1.axis0.controller.input_vel = 0
        #     last_position0 = odrv0.axis0.pos_vel_mapper.pos_rel

        # elif elapsed_time > 1.2:
        #     odrv0.axis0.controller.config.control_mode = ControlMode.POSITION_CONTROL
        #     odrv0.axis0.controller.config.vel_ramp_rate = 40
        #     odrv0.axis0.controller.config.input_mode = InputMode.TUNING
        #     odrv0.axis0.controller.input_pos = last_position0
        #     odrv1.axis0.controller.input_vel = 0
    ...
    with open('m3/data.csv', 'w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(['time','current_r100', 'Velocity_r100', 'current_maxon', 'Velocity_maxon','output_vel'])
        writer.writerows(zip(time_data, current_data_r100, vel_data_r100,current_data_maxon, vel_data_maxon,output_vel_data))
