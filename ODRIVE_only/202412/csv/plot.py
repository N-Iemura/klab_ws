...
# CSVファイルを読み込む
df = pd.read_csv('/home/naga/klab_ws/ODRIVE_only/202412/csv/two_pos_-0.1_20250128_184648.csv',skiprows=2, usecols=[0,1,3,4,6], names=['time','Ref_0', 'Position_0', 'Ref_1', 'Position_1'])
