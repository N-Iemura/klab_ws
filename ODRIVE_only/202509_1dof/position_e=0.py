...
try:
    ...
    target_position = 0.25  # 90度をターン単位で表現
    ...
    while True:
        ...
        odrv0.axis0.controller.input_pos = initial_position0 + target_position  # odrv0を90度の位置に設定
        odrv1.axis0.controller.input_pos = initial_position1                    # odrv1は初期位置を維持
