    ...
    try:
        while control_running:
            ...
            with data_lock:
                ...
                data_log['motor0']['setpoint_vel'].append(0)  # 位置制御のみなので0
                data_log['motor0']['error_pos'].append(pos_error0)
                data_log['motor0']['error_vel'].append(0)     # 位置制御のみなので0
                ...
                data_log['motor1']['setpoint_vel'].append(0)  # 位置制御のみなので0
                data_log['motor1']['error_pos'].append(pos_error1)
                data_log['motor1']['error_vel'].append(0)     # 位置制御のみなので0
