...
# CSVファイルを読み込む
df = pd.read_csv('/home/naga/klab_ws/ODRIVE_only/202502/csv/two_pos_trac_20250218_111129.csv', skiprows=2, usecols=[0, 1, 3, 4, 6, 7, 8], names=['time', 'Ref_0', 'Position_0', 'Ref_1', 'Position_1', 'Current_0', 'Current_1'])
...
# グラフを表示する
plt.tight_layout()
plt.savefig('/home/naga/klab_ws/ODRIVE_only/202502/fig/copy_trac_1.svg', format='svg')
